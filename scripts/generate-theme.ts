...
async function main() {
  writeFile(
    join(__dirname, '..', 'themes', 'Bifrost.json'),
    await Theme.init(defaultSettings)
  )

  writeFile(
    join(__dirname, '..', 'themes', 'Bifrost-flat.json'),
    await Theme.init(flatConfig)
  )

  writeFile(
    join(__dirname, '..', 'themes', 'Bifrost-darker.json'),
    await Theme.init(darkerConfig)
  )

  writeFile(
    join(__dirname, '..', 'themes', 'Bifrost-mix.json'),
    await Theme.init(mixConfig)
  )
  writeFile(
    join(__dirname, '..', 'themes', 'Bifrost-night-flat.json'),
